package com.vilin.redpackage;

import com.alibaba.google.common.primitives.Ints;
...
public class RedPackageController {
  ...
  /**
   * 拆分+发送红包
   * http://localhost:8080/redpackage/send?totalMoney=100&redPackageNumber=5
   * @param totalMoney
   * @param redPackageNumber
   * @return
   */
  @RequestMapping("redpackage/send")
  ...
  /**
   * http://localhost:8080/rob?redPackageKey=上一步的红包UUID&userId=1
   * @param redPackageKey
   * @param userId
   * @return
   */
